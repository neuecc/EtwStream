...
namespace EtwStream
{
    ...
    public static partial class ObservableEventListener
    {
        ...
        public static IObservableEventListener<EventWrittenEventArgs> FromSystemEventSource(string eventSourceName, EventLevel level = EventLevel.Verbose, EventKeywords matchAnyKeyword = EventKeywords.None, IDictionary<string, string> arguments = null)
        {
        ...
        class SystemEventSourceListener : EventListener, IObservableEventListener<EventWrittenEventArgs>
        {
